...
// target is a class or an object in general where the button is going to look for the method we want to execute
            ...
            if let firstChoice = page.firstChoice {
                ...
                firstChoiceButton.setTitle("Заново", forState: .Normal)
    ...
    override func viewWillLayoutSubviews() {
        ...
        artwork.translatesAutoresizingMaskIntoConstraints = false //turns off automatic layout a MUST
